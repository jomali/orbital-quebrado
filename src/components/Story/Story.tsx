...
const Story: React.FC<IStory> = (props) => {
  ...
  return (
    <Main>
      ...
      <DiceResult
        attribute={story.skillCheck?.attribute}
        difficulty={story.skillCheck?.difficulty}
        onAccept={story.endSkillCheck}
        open={Boolean(story.skillCheck?.difficulty)}
      />
    </Main>
  );
};
